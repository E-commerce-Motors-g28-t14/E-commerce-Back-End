...
export class InitialMigration1686085564241 implements MigrationInterface {
    name = 'InitialMigration1686085564241'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "Users" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "name" character varying(150) NOT NULL, "password" character varying(150) NOT NULL, "email" character varying(150) NOT NULL, "cpf" character varying(150) NOT NULL, "birthdate" TIMESTAMP NOT NULL DEFAULT now(), "phone" character varying(11) NOT NULL, "description" character varying(150), "isSeller" boolean NOT NULL DEFAULT true, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "UQ_3c3ab3f49a87e6ddb607f3c4945" UNIQUE ("email"), CONSTRAINT "UQ_459a9c4887a064ca812c3bfaa16" UNIQUE ("cpf"), CONSTRAINT "PK_16d4f7d636df336db11d87413e3" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "Photos" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "imageLink" character varying NOT NULL, "isCover" boolean NOT NULL DEFAULT false, "carId" uuid, CONSTRAINT "PK_60d73e2714a914f2cf23e026014" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "Cars" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "year" integer NOT NULL, "fuel" character varying(150) NOT NULL, "km" integer NOT NULL, "color" character varying(150) NOT NULL, "isPromo" boolean NOT NULL DEFAULT false, "price" character varying(150) NOT NULL, "description" character varying(150), "isActive" boolean NOT NULL DEFAULT true, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "brand" character varying(150) NOT NULL, "model" character varying(150) NOT NULL, "userId" uuid, CONSTRAINT "PK_37ee9dbe8c8c8ff70b35afaf2a8" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`ALTER TABLE "Photos" ADD CONSTRAINT "FK_674891369e42791954b0b756f4b" FOREIGN KEY ("carId") REFERENCES "Cars"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "Photos" DROP CONSTRAINT "FK_674891369e42791954b0b756f4b"`);
