...
export class AttEntity1686095893990 implements MigrationInterface {
    name = 'AttEntity1686095893990'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "adressess" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "district" character varying(150) NOT NULL, "zipCode" character varying(150) NOT NULL, "number" character varying(150) NOT NULL, "city" character varying(150) NOT NULL, "state" character varying(3) NOT NULL, "complement" character varying(150) NOT NULL, "userId" uuid, CONSTRAINT "REL_2127ca691ae7241b54f622c7e8" UNIQUE ("userId"), CONSTRAINT "PK_cf4c53ad35c0b76fbf29cd0b046" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`ALTER TABLE "adressess" ADD CONSTRAINT "FK_2127ca691ae7241b54f622c7e82" FOREIGN KEY ("userId") REFERENCES "users"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
    }

    public async down(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE "adressess" DROP CONSTRAINT "FK_2127ca691ae7241b54f622c7e82"`);
