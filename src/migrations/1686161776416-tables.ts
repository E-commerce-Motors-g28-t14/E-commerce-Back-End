...
export class Tables1686161776416 implements MigrationInterface {
    name = 'Tables1686161776416'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "comments" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "comment" character varying(250) NOT NULL, "createdAt" date NOT NULL DEFAULT now(), "updatedAt" date NOT NULL DEFAULT now(), "carId" uuid, CONSTRAINT "PK_8bf68bc960f2b69e818bdb90dcb" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "cars" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "brand" character varying(150) NOT NULL, "model" character varying(150) NOT NULL, "year" integer NOT NULL, "fuel" character varying(150) NOT NULL, "km" integer NOT NULL, "color" character varying(150) NOT NULL, "isPromo" boolean NOT NULL DEFAULT false, "price" character varying(150) NOT NULL, "description" character varying(150), "isActive" boolean NOT NULL DEFAULT true, "createdAt" date NOT NULL DEFAULT now(), "updatedAt" date NOT NULL DEFAULT now(), "userId" uuid, CONSTRAINT "PK_fc218aa84e79b477d55322271b6" PRIMARY KEY ("id"))`);
